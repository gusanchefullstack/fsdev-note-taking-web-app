# Planning
- Think deeply and create a plan for the project, list activities and allow me to validate it. 
...
@frontend-mentor-issue-fixer. Iterate max 3 times to fix any issue found in report.
